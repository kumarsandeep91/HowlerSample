...
// TODO 1: Declare more sound objects for collision detection.
// your code here
...
function init() {
  ...
  // Initialize sound variables with the help of Howler Library
    arraySounds = [soundFinDeJuego = new Howl({
      ...
      // TODO 2: Load more sounds and append them to arraySounds array. i.e here
      // your code here
    ];
...
function testCollisionWithPlayer(b, index) {
  if(circRectsOverlap(player.x, player.y,
    ...
    if(b.color === colorToEat) {
      ...
      // TODO 4: Play a sound with .play() method
      // your code here
    }
...
function drawFilledRectangle(r) {
    ...
    // load image/avatar and draw it on canvas.
